                ...
                properties: [
                    "source": [
                        ...
                        "properties": [
                            ...
                            "path": ["type": "string", "description": "Absolute local file or directory path, readable by the Prato process. A directory is imported recursively — every openable file is pulled in and the folder structure is replicated as media folders."],
